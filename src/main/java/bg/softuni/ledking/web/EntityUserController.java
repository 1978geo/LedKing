...
public abstract class EntityUserController<ServiceModel, ViewModel> {

    private final static Logger logger = LoggerFactory.getLogger(EntityUserController.class);
