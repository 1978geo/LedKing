...
export function MenuDialog() {
  ...
  return (
    ...
    >
      ...
      <DialogContent className='flex px-4 flex-col gap-y-4 bg-[rgba(171,168,187,0.2)]  backdrop-blur-xl w-[calc(100%-20px)] mx-auto rounded-md border-border md:max-w-xs'>
